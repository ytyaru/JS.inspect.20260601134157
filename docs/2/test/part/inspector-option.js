...
describe("InspectorOption", () => {
    ...
    describe("create()", () => {
        ...
        describe("例外発生", () => {
            ...
            test('({str:{x:1}})',()=>terr(()=>InspectorOption.create({str:{x:1}}), Error, `引数不正。str.xは不正なキーです。`)());
            test('({sym:{x:1}})',()=>terr(()=>InspectorOption.create({sym:{x:1}}), Error, `引数不正。sym.xは不正なキーです。`)());
            test('({ins:{x:1}})',()=>terr(()=>InspectorOption.create({ins:{x:1}}), Error, `引数不正。ins.xは不正なキーです。`)());
